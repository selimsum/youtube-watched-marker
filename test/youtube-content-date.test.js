...
describe('parsePublishDateText', () => {
  ...
  test('should parse "Streamed 2 days ago"', () => {
  ...
  test('should parse exact dates like "15.11.2023"', () => {
  ...
  test('should handle exact dates with formatting', () => {
  ...
  test('should parse MM/DD/YYYY handled as DD.MM.YYYY due to logic', () => {
    const result = parsePublishDateText('15/11/2023');
    assert.ok(result);
    assert.strictEqual(result.precision, 'exact');
    assert.strictEqual(result.publishedMs, new Date(2023, 10, 15).getTime());
  ...
  test('should parse Month DD YYYY', () => {
  ...
  test('should parse DD Month YYYY', () => {
  ...
  test('should parse Turkish month names', () => {
  ...
  test('should parse Turkish relative dates', () => {

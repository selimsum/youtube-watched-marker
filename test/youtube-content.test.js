...
describe("absoluteUrl", () => {
  it("should return absolute URL string for a valid URL string", () => {
    assert.strictEqual(sandbox.absoluteUrl("/test"), "https://www.youtube.com/test");
  });
  it("should return null for an invalid URL string that throws in new URL()", () => {
    assert.strictEqual(sandbox.absoluteUrl("http://[::1]:80:80"), null);
  });
  it("should return null for non-string/empty inputs", () => {
